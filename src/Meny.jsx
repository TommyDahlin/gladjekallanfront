      ...
      <div className="meny-container">
        <div className="meny-part">
          ...
          <div className="sausage-type">
            <br /> Hamburgersorter: Högrev eller Halloumi
          </div>
            ...
            <div className="meny-type">
              <ul className="meny-list">
                ...
                <li className="meny-item">
                  ...
                  <div className="meny-description">
                    Ost <br /> Bacon <br /> Stekt lök <br />
                    Hamburgerdressing
                    <br /> Sallad <br /> Tomat <br /> BBQ Sås
                  </div>
                </li>
                <li className="meny-item">
                  <div className="meny-name">Atleten</div>
                  <div className="meny-description">
                    Ost <br /> Bacon <br /> Stekt lök <br /> Vitlöksmayo <br />{" "}
                    Sallad <br /> Jalapeño <br /> Sriracha Mayo{" "}
                  </div>
                </li>
              </ul>
              <ul className="meny-list">
                <div className="hamburger-type-container">
                  <li className="meny-item">
                    ...
                    <div className="meny-description">
                      Ost <br /> Bacon x 2 <br /> Vitlöksmayo <br /> Sallad{" "}
                      <br /> Rå lök <br /> Tomat <br /> BBQ Sås
                    </div>
                  </li>
                  ...
                  <li className="meny-item">
                    ...
                    <div className="meny-description">
                      Ost <br /> Bacon x 2 <br /> Stekt lök <br /> Sallad <br />{" "}
                      Picklad rödlök <br /> Tomat <br /> Tryffelmayo
                    </div>
                  </li>
                  <li className="meny-item">
                    <div className="meny-name">Butchern</div>
                    <div className="meny-description">
                      Ost <br /> Bacon x 2 <br /> Hamburgerdressing <br />{" "}
                      Sallad <br /> Rå lök <br /> Ketchup <br /> Senap{" "}
                    </div>
                  </li>
                  <li className="meny-item">
                    <div className="meny-name">Starke Adolf</div>
                    <div className="meny-description">
                      Ost <br /> Bacon <br /> Hamburgerdressing <br /> Sallad{" "}
                      <br /> Jalapeño <br /> Tomat <br /> Sriracha{" "}
                    </div>
                  </li>
                </div>
              </ul>
        ...
        <div className="meny-part">
          ...
          <div className="sausage-type">
            <br /> Korvsorter: Fläsk, Kyckling, Vegetarisk
          </div>
          <ul className="meny-list">
            <li className="meny-item">
              <img
